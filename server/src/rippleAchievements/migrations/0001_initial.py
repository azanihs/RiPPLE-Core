...
class Migration(migrations.Migration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('rippleAchievements_achievement', (
        ...
        db.send_create_signal('rippleAchievements', ['Achievement'])

        # Adding model 'UserAchievement'
        db.create_table('rippleAchievements_userachievement', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('rippleAchievements', ['UserAchievement'])


    def backwards(self, orm):
        
        # Deleting model 'Achievement'
        db.delete_table('rippleAchievements_achievement')

        # Deleting model 'UserAchievement'
        db.delete_table('rippleAchievements_userachievement')
