...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('rippleAchievements', '0001_initial'),
    ]
    ...
    def forwards(self, orm):
        ...
        db.delete_column('rippleAchievements_userachievement', 'profile_id')

        # Adding field 'UserAchievement.user'
        db.add_column('rippleAchievements_userachievement', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('rippleAchievements_userachievement', 'user_id')
    ...
    models = {
        ...
        'rippleAchievements.userachievement': {
            ...
            'achievement': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['rippleAchievements.Achievement']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
