...
class LeaderboardTest(BootstrapTestCase):
    ...
    def test_leaderboard_fetch(self):
        ...
        leaderboard = QuestionService.get_course_leaders(course, "questionsAuthored", "")
    ...
    def test_leaderboard_sort_direction(self):
        ...
        leaderboard = QuestionService.get_course_leaders(course, "questionsAuthored", "DESC")
        self.assertEqual(len(leaderboard), 5)
        ...
        leaderboard = QuestionService.get_course_leaders(course, "questionsAuthored", "ASC")
        self.assertEqual(len(leaderboard), 5)
    ...
    def test_leaderboard_fetch_multiple(self):
        ...
        leaderboard = QuestionService.get_course_leaders(courses[0], "questionsAuthored", "")
        self.assertEqual(len(leaderboard), 5)

        leaderboard = QuestionService.get_course_leaders(courses[1], "questionsAuthored", "")
    ...
    def test_leaderboard_fetch_many_instructor(self):
        ...
        for i in range(0, 100):
            self._boostrap_leaderboard_users(course, i, i == 1)
        leaderboard = QuestionService.get_course_leaders(course, "questionsAuthored", "DESC", limit=-1)
